...
public class NCPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> BIG_SHALE_CLUSTER = createKey("big_shale_cluster");
    public static final ResourceKey<PlacedFeature> BIG_GABBRO_CLUSTER = createKey("big_gabbro_cluster");
