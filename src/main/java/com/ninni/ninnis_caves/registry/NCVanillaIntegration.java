...
public class NCVanillaIntegration {
    ...
    private static void registerBiomeModifications() {
        ...
        BiomeModifications.create(new ResourceLocation(NinnisCaves.MOD_ID, "remove_dirt")).add(ModificationPhase.REMOVALS, BiomeSelectors.tag(BiomeTags.IS_OVERWORLD), (biomeModificationContext) -> {
            biomeModificationContext.getGenerationSettings().removeFeature(OrePlacements.ORE_DIRT);
        });
        BiomeModifications.create(new ResourceLocation(NinnisCaves.MOD_ID, "remove_diorite")).add(ModificationPhase.REMOVALS, BiomeSelectors.tag(BiomeTags.IS_OVERWORLD), (biomeModificationContext) -> {
        ...
        BiomeModifications.create(new ResourceLocation(NinnisCaves.MOD_ID, "remove_granite")).add(ModificationPhase.REMOVALS, BiomeSelectors.tag(BiomeTags.IS_OVERWORLD), (biomeModificationContext) -> {
        ...
        BiomeModifications.create(new ResourceLocation(NinnisCaves.MOD_ID, "remove_andesite")).add(ModificationPhase.REMOVALS, BiomeSelectors.tag(BiomeTags.IS_OVERWORLD), (biomeModificationContext) -> {
        ...
        BiomeModifications.create(new ResourceLocation(NinnisCaves.MOD_ID, "replace_gravel")).add(ModificationPhase.REPLACEMENTS, BiomeSelectors.tag(BiomeTags.IS_OVERWORLD), biomeModificationContext -> {
